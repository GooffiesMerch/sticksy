...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "9kj2kd-bc.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "50ac58868a18fb470057c63d74a0e454";
...
export async function fetchProducts(
  ...
  // Always exclude products tagged "hidden" from public listings unless explicitly included.
  const finalQuery = options.includeHidden
    ? query
    : query
      ? `(${query}) AND -tag:hidden`
      : "-tag:hidden";
