...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sticksy designs premium vinyl stickers and custom skins for split air conditioners — anime, cars, Marvel, football and your own artwork." },
      { property: "og:site_name", content: "Sticksy" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description: "Premium vinyl stickers and custom skins for split air conditioners.",
        }),
      },
    ],
  }),
