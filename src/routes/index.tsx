        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {([
              ...
              { name: "Ayesha R.", city: "Lahore", text: "Got the AMG GT sticker for my brother's gaming room. The way it glows under his RGB lights at night is unreal — he keeps staring at the AC instead of the monitor.", img: rvAnime, alt: "AMG GT car sticker on AC glowing under RGB gaming lights" },
